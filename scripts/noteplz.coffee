...
module.exports = (robot) ->
  ...
  robot.hear /show notes about (.*)/i, (res) ->
    ...
    url = "https://api.hipchat.com/v2/room/Wergroot/history?&date=2015-05-16&timezone=Asia/Tokyo&format=json&auth_token=1coJkivHvITLQx343j75ziWKvjZX5VHG1Faus4hz"
    console.log(url);
    robot.http(url)
      .get() (err, resp, body) ->
        if err
